  ...
  return (
    <aside className="w-64 bg-slate-900 text-slate-300 min-h-[calc(100vh-4rem)] flex flex-col border-r border-slate-800 shrink-0 select-none">
      <div className="p-5 border-b border-slate-800">
        <h1 className="text-white font-extrabold text-xl tracking-tight leading-none bg-gradient-to-r from-emerald-400 via-purple-300 to-blue-400 bg-clip-text text-transparent">
          BookNest
        </h1>
        <span className="text-[10px] uppercase font-bold text-purple-400 tracking-wider block mt-1">Hotel Management System</span>
      </div>
