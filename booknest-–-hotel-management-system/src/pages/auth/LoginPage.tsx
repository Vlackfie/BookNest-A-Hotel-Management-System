      ...
      <div className="relative z-10 w-full max-w-4xl grid grid-cols-1 lg:grid-cols-12 gap-8 items-center bg-slate-900/50 backdrop-blur-2xl border border-white/10 rounded-3xl p-6 sm:p-10 shadow-2xl shadow-purple-950/50">
        ...
        <div className="lg:col-span-6 space-y-6">
          <div className="flex items-center gap-4">
            <div className="relative p-2 bg-slate-900/80 rounded-2xl border border-purple-500/30 shadow-lg shadow-purple-500/20 overflow-hidden group">
              <img
                src="/logo.jpg"
                alt="BookNest Logo"
                className="w-14 h-14 object-contain rounded-xl transform transition-transform group-hover:scale-105"
                referrerPolicy="no-referrer"
              />
              <div className="absolute inset-0 rounded-2xl bg-gradient-to-tr from-emerald-500/10 via-purple-500/10 to-blue-500/10 pointer-events-none"></div>
            </div>
            <div>
              ...
              <p className="text-xs uppercase tracking-widest font-bold text-purple-400/90 mt-0.5">
