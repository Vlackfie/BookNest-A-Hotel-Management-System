    ...
    <div className="space-y-6 animate-fade-in">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <div className="flex flex-wrap items-center gap-2">
          <a
            href="/ALL_PROJECT_CODE.txt"
            download="BookNest_Full_Project_Code.txt"
            className="px-3.5 py-1.5 bg-gradient-to-r from-emerald-500 via-purple-600 to-blue-600 hover:from-emerald-400 hover:via-purple-500 hover:to-blue-500 text-white rounded-xl text-xs font-bold transition-all shadow-md flex items-center gap-1.5 shrink-0"
          >
            <Download className="w-3.5 h-3.5" />
            <span>Download All Code (.txt)</span>
          </a>

          <div className="bg-slate-200 dark:bg-slate-800 p-1 rounded-xl flex flex-wrap gap-1">
            <button
